...
export const Introduction = () => {
  return (
    ...
    >
      ...
      >
        <h1 className='text-center mb-10'>intro</h1>
        ...
        <p className='mb-10'>interested in ...</p>
        <button>
      ...
      >
        ...
        >
          <img 
            ...
            className='h-[250px] w-[200px] brightness-50'
          />
          <h1 className='absolute top-1/2 text-4xl -mt-[0.6em] -right-[1.5em] font-bold brightness-75'>i like art :)</h1>
        </div>
      </div>
    </div>
  )
